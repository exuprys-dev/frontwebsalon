...
import { register, loginWithGoogle } from "../api/axios";
...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        setError("");
        try {
            const data = await register(form); // utilise la fonction de axios.js
    ...
    const handleGoogle = () => {
        ...
        loginWithGoogle(); // fonction de axios.js
    };

    return (
        <div className="reg-page">
            <div className="reg-box">
                <h1 className="reg-title">Créer un <span>Compte</span></h1>
                <p className="reg-sub">Rejoignez Salon Chez Elle</p>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input className="form-input" type="text" name="name"
                            placeholder="Antoine Dupont" value={form.name}
                    ...
                    {/* <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-input" type="text" name="first_name"
                                placeholder="Antoine" value={form.first_name}
                                onChange={handleChange} required />
                        </div>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-input" type="tel" name="phone"
                            placeholder="0101010101" value={form.phone}
