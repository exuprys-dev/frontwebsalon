...
function Login() {
    ...
    const handleGoogle = () => {
        // Mémorise la destination avant de partir vers Google
        const from = location.state?.from || "/";
        localStorage.setItem("redirectAfterLogin", from);
        loginWithGoogle(); // window.location.href vers Laravel
    };

    return (
        <div className="login-page">
            <div className="login-box">
                <h1 className="login-title">Bon <span>Retour</span></h1>
